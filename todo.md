...
## Correção de Autenticação Firebase (v1.3.1)
- [x] Corrigir autenticação Google para React Native (signInWithPopup não funciona)
- [x] Implementar autenticação com Expo Web Browser
- [x] Testar login Google e Apple
